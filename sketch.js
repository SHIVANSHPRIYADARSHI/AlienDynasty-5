...
var playimg, level1img, leftwall, rightwall,bgMusic
...
function preload() {
    ...
    popUpImg = loadImage("assets/AboutGame.gif")
    spikes = loadImage("assets/spikes-removebg-preview.png")
    playerimg=loadImage("assets/alien.gif")
...
function setup() {
    ...
    level1popbutton = createImg("assets/AboutGame.gif")
